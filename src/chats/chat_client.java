...
public class chat_client extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        msg_text.setText("Tuliskan pesan anda");
    ...
    public static void main(String args[]) {
        ...
        try{
            s = new Socket("127.0.0.1",1201);//here the ip address is local addr. bcaus in running theclient and server at same computer
